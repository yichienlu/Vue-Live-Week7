    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content border-0">
              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-for="item in tempOrder.products" :key="item.id">
                    ...
                    <td>{{ item.qty }} x {{ item.product.price }} / {{ item.product.unit }}</td>
                    <td class="text-end">
                      {{ item.final_total }}
                    </td>
                  </tr>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" @click="this.$emit('edit-order', tempOrder)">
            確認修改
          </button>
        </div>
      </div>
